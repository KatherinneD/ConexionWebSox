<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site.Master" CodeBehind="CrearPuntoControl.aspx.cs" Inherits="ConexionWeb.PuntoControl.CrearPuntoControl" Async="true"%>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="form-horizontal">
        ...
        <div class ="form-group">
            ...
            <div class="col-md-10"><asp:TextBox CssClass="form-control" runat="server" ID="txtPuntoControl"></asp:TextBox> </div>
        </div>
        <div class ="form-group">
